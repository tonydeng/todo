...
public class TodoDBAdapter {
	...
	public boolean isTaskChecked(String task){
		Cursor c = database.query(DATABASE_TABLE, new String[]{KEY_STATE}, KEY_STATE+"=?", new String[]{task}, null, null,null);
		Log.d("is task checked DBTEST", ""+c.getInt(c.getColumnIndex(KEY_STATE)));
	...
	public long updateTask(String task, int completed){
		...
		return database.update(DATABASE_TABLE, values, KEY_TASK+"=?", new String[]{task});
	}
	...
	public Cursor fetchAllTasks(){
		return database.query(DATABASE_TABLE, new String[]{KEY_ROWID, KEY_TASK, KEY_STATE}, null, null, null, null, null);
	}
	
	public Cursor fetchTask(String task){
		return database.query(DATABASE_TABLE, new String[]{KEY_ROWID, KEY_TASK, KEY_STATE}, KEY_TASK+"=?", new String[]{task}, null, null, null);
	}
}
